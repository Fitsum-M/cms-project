...
{
    public function show(string $slug, FrontendContentService $content, GeneralSettings $settings): View|RedirectResponse
    {
        if ($slug === HomepagePageFields::HOME_NAV_SLUG) {
